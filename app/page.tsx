...
export default function Home() {
  ...
  function toggleTheme() {
    ...
    // trigger a short animation on the icon
    setAnim(true)
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] flex flex-col transition-colors duration-500">
      {/* Theme toggle - Top Right (animated switch) */}
      ...
      {/* Main Content Area */}
        ...
        <div className="flex-1 flex items-start justify-start px-8 py-12">
            ...
            <div className="hero-grid rounded-xl">
              <div className="max-w-3xl">
                ...
                <div className="mt-3 flex gap-4">
                  <a href="https://cloudcode.io.vn" className="outlined-button">Tui Cũng muốn!</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-8 left-8">
        <a href="/" className="text-sm font-mono text-gray-700 dark:text-white opacity-90">{host || 'example.com'}</a>
      </div>
    </main>
  )
}
